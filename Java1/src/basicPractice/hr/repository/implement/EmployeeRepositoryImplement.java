...
public class EmployeeRepositoryImplement implements EmployeeRepository {
	...
	public boolean save(EmployeeEntity employeeEntity) {
		...
		for (int index = 0; index < list.size(); index++) {
			...
			boolean isEqualEmployeeNumber = employeeEntity.getEmployeeNumber().equals(employeeNumber);
...
//			boolean isEqualEmployeeNumber = item.getEmployeeNumber().equals(employeeEntity.getEmployeeNumber());
//			if(isEqualEmployeeNumber) {
//				list[index] = employeeEntity;
//				result = true;
//				break;
